...
* Spamming, advertising, or soliciting
...
* GitHub repositories and all associated features (issues, pull requests, discussions, etc.)
...
[conduct@yourproject.com](mailto:conduct@yourproject.com).
...
* **GitHub**: Open a confidential issue using the security tab
...
* Communicate outcome to all involved parties
...
the one who made the initial enforcement decision.

## Questions

If you have questions about this Code of Conduct, please reach out to the
project maintainers at conduct@yourproject.com.
